...
Runs the specifcied Package's 'build all' script
===============================================================================
usage: orc [common-opts] build [options] <pkgname>
...
#---------------------------------------------------------------------------------------------------------
def display_summary():
    print("{:<13}{}".format( 'build', "Runs the package's build all script." ))
...
def run( common_args, cmd_argv ):
    ...
    script  = os.path.join( pkgroot, 'top', 'tools', 'build.py' )
